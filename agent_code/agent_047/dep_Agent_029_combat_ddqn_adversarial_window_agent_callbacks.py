"""Agent 029 callbacks: Agent 027 control with its own 101-input features."""
...
from . import dep_Agent_029_combat_ddqn_adversarial_window_agent_features as features
from .dep_Agent_029_combat_ddqn_adversarial_window_agent_features import ACTIONS


MODEL_PATH = Path(__file__).resolve().parent / "adversarial_window_checkpoint.pt"
RESUME_PATH = None
