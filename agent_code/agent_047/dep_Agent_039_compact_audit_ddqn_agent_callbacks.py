"""Agent 039 callbacks with the compact audit feature contract."""
...
from . import dep_Agent_039_compact_audit_ddqn_agent_features as features
from .dep_Agent_039_compact_audit_ddqn_agent_checkpoint import compact_agent038_checkpoint
from .dep_Agent_039_compact_audit_ddqn_agent_features import ACTIONS
...
def setup(self):
    ...
    if self.train and RESUME_PATH is not None:
        _base.load_checkpoint = lambda path: compact_agent038_checkpoint(
    ...
    # _base.setup may install its default module; restore Agent 039 explicitly
    # before any probe or action is generated.
    self.feature_module = features
...
__all__ = [
    "MODEL_PATH", "RESUME_PATH", "act", "next_features",
    "progress_signature", "save_checkpoint", "setup", "state_key",
]
