"""DDQN callbacks with exact action-time short-cycle context."""
...
from .dep_combat_dqn_agent_callbacks import (
    MODEL_PATH as _BASE_MODEL_PATH,
)
from .dep_combat_dqn_agent_model import DEVICE
from .dep_combat_fqi_agent_safety import action_is_legal

from . import dep_Agent_025_combat_ddqn_short_cycle_agent_features as features
from .dep_Agent_025_combat_ddqn_short_cycle_agent_features import ACTIONS


MODEL_PATH = Path(__file__).resolve().parent / "short_cycle_checkpoint.pt"
RESUME_PATH = None
